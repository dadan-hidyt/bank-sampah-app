 ...
 *   https://datatables.net/download/#dt/jq-3.6.0/dt-1.12.1/b-2.2.3/sp-2.0.2/sl-1.4.0
 *
 * Included libraries:
 *   jQuery 3 3.6.0, DataTables 1.12.1, Buttons 2.2.3, SearchPanes 2.0.2, Select 1.4.0
 */
...
a,d=this.aiDisplay.length,e=this.oFeatures,h=e.bPaginate;return e.bServerSide?!1===h||-1===a?b+d:Math.min(b+a,this._iRecordsDisplay):!h||c>d||-1===a?d:c},oInstance:null,sInstance:null,iTabIndex:0,nScrollHead:null,nScrollFoot:null,aLastSort:[],oPlugins:{},rowIdFn:null,rowId:null};u.ext=M={buttons:{},classes:{},build:"dt/jq-3.6.0/dt-1.12.1/b-2.2.3/sp-2.0.2/sl-1.4.0",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},header:{}},order:{},type:{detect:[],
